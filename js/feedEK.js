...
(function ($) {
	$.fn.FeedEk = function (options) {
		...
		var getFeedData = function () {
			divFeed.empty();
			divFeed.append('<div class="loading"><img src="assets/img/loader.gif" /></div>');
			$.ajax({
				...
				success: function (result) {
					...
					divFeed.append('<a href="https://www.simplifyingthemarket.com/en/" class="btn btn-primary btn-md text-uppercase" target="_blank">Read More</a>');
